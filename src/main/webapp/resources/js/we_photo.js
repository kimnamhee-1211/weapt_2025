 ...
 * CRUD 공통 function
 *
 * async function we_selectPhoto : 공통 select 함수
 *
 *
 **/
...
//공통 select 함수
async function we_selectPhoto(data, {successSelectPhoto} = {}, timeout = 60_000) {
    ...
    try {
        ...
        if (!isNull(json) && json.O_STATUS === "FAIL") {
            alert(json.O_MSG);
            return;
        }

        if (typeof successSelectPhoto === "function") await successSelectPhoto();
