        ...
        <div id="section">
            <div class="section1">
                <div class="section1_nav">
                    <span><i class="icon-recycle"></i>적립요구액(잔여계획기간)</span>
                </div>
            ...
            <div id="" class="soo04020_gridcontainer">
                            ...
                            <tr>
                                ...
                                <!-- <button style="height:25px;">면적단가</button> -->                                
                                    <span class="section_middle_btn">
                                        <input type="checkbox" id="soo04020_layer_popup" class="layer_popup">
                                        <label for="soo04020_layer_popup" class="pop_labal popup_btn">면적단가</label>
                                        <!-- 변경 팝업시작--> 
                                        <div class="layer_bg">
                                            <div class="popup" style="width:400px;">
                                                <div class="pop_title">&#10004;면적단가설정</div>
                                                <form action="." method="post">
                                                    <div style="height:100px; padding: 30px; border: 1px solid #bcbcbc;">
                                                ...
                                                <div class="pop_btn">
                                                    ...
                                                    <label for="soo04020_layer_popup" class="popup_closs_btn">닫기</label>                    
                                                </div>
                                            </div>
                                        </div>
                                        <!-- 팝업끝-->
                ...
                <div>
                &#9726&nbsp;월간 세대별 장기수선충당금 적립요구액 (잔여계획기간)
                </div>
