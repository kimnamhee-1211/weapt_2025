...
<%@ include file = "hom_nav.jsp" %>
        ...
        <div id="section">
            <div class="section1">
                <span class="section1_nav"><i class="icon-home"></i>공지사항</span> <%-- 메뉴클릭시 바로 검색됨--%>
                <div class="section1_btn">  <%-- 책임관리자만 보이는 작성버튼--%>
                    <button id="write_btn" onclick="" class="admin_btn"><a href="hom02010write.jsp">작성</a></button>
                </div>
            </div>
            <div class="section2">
                <div class="section2_line1">
                    <form action="." method="post">
                        <span class="select-container">검색조건 :&nbsp;
                            <select id="" name="" class="sbox_width100">
            ...
            <div style="height: 566px; border: 1px solid #bcbcbc;">
                <div id="" name="">
                    ...
                    <a href="hom02010reading.jsp">----예시클릭</a>
                </div>
            </div>
