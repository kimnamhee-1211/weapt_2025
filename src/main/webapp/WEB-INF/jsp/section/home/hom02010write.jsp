...
<%@ include file = "hom_nav.jsp" %>
        ...
        <div id="section">
            <div class="section1">    <%--관리자 페이지 임. 처음 작성 페이지 그리고 그리드 클릭으로 써진 것 나올때 사용--%> 
                <span class="section1_nav"><i class="icon-home"></i>공지사항(관리자작성 읽기[수정])</span>
                <div class="section1_btn">
                    <button id="save_btn" onclick="">저장</button>
                    <button id="list_btn" onclick=""><a href="hom02010.jsp">목록</a></button>
            ...
            <div class="section2">
                <div class="section2_line2">
                    <form action="." method="post">
                        ...
                        <div>
                            <span class="">
                                <label for="popup_use">팝업창사용 :&nbsp;</label>
                                <input type="checkbox" id="popup_use" name="popup_use" value="팝업창사용">
                            </span>
                            <span class="">&emsp;팝업기간 :&nbsp;
                                <input type="date" id="today" value="<%= today %>">&nbsp;~&nbsp;
                                <input type="date" id="today" value="<%= today %>">
                            </span>
                            <span class="">&emsp; 팝업창크기 :&nbsp; 
                                &emsp; 가로&nbsp; 
                                <input type="text" id="" class="box_width70">&nbsp;px
                                &emsp; 세로&nbsp;
                                <input type="text" id="" class="box_width70">&nbsp;px                     
                            </span>
                        </div>
            ...
            <div style="height: 529px; border: 1px solid #bcbcbc;">
                <div id="" name="">
                    스마트 에디터 영역
                </div>
            </div>
