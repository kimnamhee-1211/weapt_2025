...
<%@ include file = "hom_nav.jsp" %>
        ...
        <div id="section">
            <div class="section1">
                <span class="section1_nav"><i class="icon-home"></i>장기수선계획</span> <%-- 메뉴클릭시 바로 검색됨--%>
                <div class="section1_btn">
                    <button id="write_btn" onclick="" class="admin_btn"><a href="hom03030write.jsp">작성</a></button>                  
            ...
            <div style="height: 566px; border: 1px solid #bcbcbc;">
                <div id="" name="">
                    ...
                    <a href="hom03030reading.jsp">예시클릭</a>
                </div>
            </div>
