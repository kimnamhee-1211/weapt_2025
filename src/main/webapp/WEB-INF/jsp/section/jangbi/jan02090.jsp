...
<%@ include file = "jan_nav.jsp" %>
        ...
        <div id="section">
            <div class="section1">
                <div class="section1_nav"><i class="icon-cog-alt"></i>장비이력카드</div> <!-- 설비영선 용-->
                <div class="section1_btn">
                    ...
                    <button id="list_btn" onclick=""><a href="jan02010.jsp">목록</a></button>
            ...
            <div class="jangbicontainer">
                <div id="sajin" class="gridcont_left_535 left-item">
                    <div class="jangbi_sajin" style="height: 280px; border: 1px solid #bcbcbc;">
                    사진
                    </div>
                </div>
                <div id="jangbi_note" class="gridcont_right_535 .right-item">
                    <form action="." method="post">
