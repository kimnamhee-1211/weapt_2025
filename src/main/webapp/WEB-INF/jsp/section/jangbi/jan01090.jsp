                    ...
                    <table class="jan01015_table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <textarea class="jan01015_textarea" name="REMARKS" id="input_remarks"></textarea></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<script>
    ...
    const jangbi_note = document.querySelector("#jangbi_note"); // 입력부 컴포넌트
    ...
    function save_input1_onclick(){
        ...
        let item = inputToData("jangbi_note")
    ...
    function delete_input1_onclick(){
        ...
        if (!confirm( input_equName.value + "을/를 삭제하시겠습니까?")) return;
    ...
    window.onload = function() {
        ...
        btnMaker({ tag: "#section1_btn", grid:"input1", save: true, del:true });
        btnMaker({ tag: "#section_middle_btn1", grid:"grid1", add: true, save: true, del : true, print: true});
        //crud 권한 처리 함수
