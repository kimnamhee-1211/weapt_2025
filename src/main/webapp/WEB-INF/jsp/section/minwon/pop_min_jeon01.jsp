            ...
            <div id="input1">
                ...
                <table style="width:720px;" id="minwon_table">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <span>
                                <input type="date" class="box50" id="input_minwonDate" name="MINWON_DATE" data-format="date">
                            </span>&emsp;&emsp;
                            ...
                            <%-- 체크되면 시,분 보여지기 --%>
                            <span>&ensp;:
                                <input type="time" class="box50" id="input_time" name="TIME" style="display: none;">
                            </span>
                        </td>
                        <th>전표번호</th>
                        <%-- 오늘날짜 순번으로 자동생성 --%>
