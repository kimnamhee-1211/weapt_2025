            ...
            <table style="width:720px;" id="minwon_table">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <%-- 체크되면 시,분 보여지기 --%>
                        <span>&ensp;: <input type="time" id="input_time" name="TIME" class="box50"  style="display: none;"></span>
                    </td>
                    <th>전표번호</th>
                    <%-- 오늘날짜 순번으로 자동생성 --%>
            ...
            <table style="width:720px;" id="minwonWork_table">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <span>&ensp;: <input type="time" id="input_workTime" name="WORK_TIME" style="display: none;"></span>
                    </td>
                    <th>구분</th>
                    <td>
...
<script>
    ...
    function search_input1_onclick() {
        ...
        let selectParam = {
            ...
            MINWON_DATE: input_minwonDate.value,
        }
    ...
    function info_tr_make(){
        ...
        if (pop_data1.gbn == "0") {
            info_tr.innerHTML = `
                            <th>동호</th>
                            <td>
                                <input type="text" id="input_dongHo" name="DONG_HO" class="box50" disabled>
                            </td>
                            <th>민원인</th>
                            <td ><input type="text" id="input_minwonName" name="MINWON_NAME"></td>
                            <th>연락처</th>
            ...
            info_tr.innerHTML = `
                            <th>동열</th>
                            <td>
                                <input type="text" id="input_dongLine" name="DONG_LINE" class="box50" disabled>
                            </td>
                            <th>민원인</th>
                            <td ><input type="text" id="input_minwonName" name="MINWON_NAME"></td>
                            <th>연락처</th>
            ...
            info_tr.innerHTML = `
                            <th>장소</th>
                            <td>
                                <input type="input_arearName" id="MINWON_NAME" class="box200">
                            </td>
                            <th>민원인</th>
                            <td ><input type="text" id="input_minwonName" name="MINWON_NAME"></td>
                            <th>연락처</th>
    ...
    function requireCheck(require){
        ...
        switch(require){
            ...
            case "SAVE_INPUT2":
                ...
                if(isNull(input_workDesc.value)){
                    isValid = false;
                }
                break;
        }
    ...
    function pop_onload1(pop_item) {
        ...
        btnMaker({tag: "#section_middle_btn1", grid: "input1", save: true, del: true, print: true});
