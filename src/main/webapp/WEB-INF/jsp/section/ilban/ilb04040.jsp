...
<jsp:include page="/WEB-INF/jsp/section/ilban/ilb_nav.jsp" />
    ...
    <div id="section">
            <div class="section1">
                <div class="section1_nav"><i class="icon-chart-bar"></i>근태관리환경설정</div>
...
<script>
    ...
    const grid1ColumnLayout = [
        ...
        { dataField: "ABSENT_NAME",
            headerText: "근태",
            dataType: "text",
            width : "20%",
        },
        { dataField: "ABSENT_DESC",
            headerText: "근태해설",
            dataType: "text",
            width : "*%",
    ...
    function regist_onclick(){
        ...
        if (!confirm("기본 근태 목록을 불러오시겠습니까?(기존 목록은 모두 삭제됩니다.)")) return;
        let checkedItems = AUIGrid.getColumnValues(grid1, "ABSENT_CD");
        ...
        switch(require){
            case "SAVE_GRID1":
                ...
                for(const row of items){
                    if(isNull(row.ABSENT_NAME)){
                        alert("근태명은 반드시 입력해야 합니다.");
                        isValid = false;
                        break;
                    }
                }
    ...
    window.onload = function() {
        ...
        document.querySelector("#section1_btn").insertAdjacentHTML("afterbegin", "<button id='regist_btn' onclick='regist_onclick()' class='admin_btn'>기본근태등록</button>");
