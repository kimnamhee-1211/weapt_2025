        ...
        <div class="gridcont_right_620">
            ...
            <div class="attendance" id="input_absent">
                ...
                <div>&emsp;&#9726&nbsp;기&emsp;&emsp; &nbsp;&nbsp;간&nbsp; :&nbsp;
                    <input type="date" id="input_startDate" name="START_DATE">&nbsp; ~ &nbsp;<input type="date"
                                                                                                    id="input_endDate"
                                                                                                    name="END_DATE">
                </div>
                <div>&emsp;&#9726&nbsp;실사용일수 :&nbsp;
                    <input type="text" id="input_useDayCnt" name="USE_DAY_CNT" class="search-txt100">
                    &nbsp;(휴일을 제외한 실제사용일수, 반차인경우 0.5)
                </div>
...
<script>
    ...
    async function getSelect_input1_absentCd() {
        ...
        if (list) {
            list.forEach(row => {
                input_absentCd.insertAdjacentHTML("beforeend",
                    "<option value='" + row.ABSENT_CD + "'>" + row.ABSENT_NAME + "</option>");
            })
        }
    }
