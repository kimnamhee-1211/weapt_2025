...
<jsp:include page="/WEB-INF/jsp/section/iljung/ilj_nav.jsp" />
    ...
    <div id="section">
        ...
        <div id="conf_line">
            ...
            <div id="grid1" class="conf_line_right" style="border: 1px solid #bcbcbc;"></div> //결재란
        </div>
        <div id="grid2"  style="height: 546px; border: 1px solid #bcbcbc;"></div>
    </div>
...
<script>
    ...
    async function grid1_column_make(){
        ...
        list.forEach((row, idx)=>{
            let item = {};
            item.dataField  = row.ABSENT_CD;
            item.headerText = row.ABSENT_NAME;
