...
<jsp:include page="/WEB-INF/jsp/section/iljung/ilj_nav.jsp" />
        ...
        <div id="section">
            <div class="section1">
                <div class="section1_nav"><i class="icon-calendar-plus-o"></i>월중핵심과제등록</div>
...
<script>
    ...
    function regist_onclick(){
        ...
        if (!confirm("기본 목록을 불러오시겠습니까?(기존 목록은 모두 삭제됩니다.)")) return;

        let checkedItems = AUIGrid.getColumnValues(grid1, "MST_NO");
        ...
        switch(require){
            case "SAVE_GRID1":
                ...
                for(const row of items){
                    ...
                    if(isNull(row.MST_MONTH)){
                        alert("등록월은 반드시 입력해야 합니다.");
                        isValid = false;
                        break;
                    }
                }
