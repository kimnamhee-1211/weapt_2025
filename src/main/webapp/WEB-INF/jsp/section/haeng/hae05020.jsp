...
<jsp:include page="/WEB-INF/jsp/section/haeng/hae_nav.jsp" />
        ...
        <div id="section">
            <div class="section1">
                <div class="section1_nav"><i class="icon-edit"></i>폐기문서</div>
                <div class="section1_btn" id="section1_btn"></div>
            </div>
            <div class="section2">
                <div class="section2_line1">   <%-- 검색조건 기간만--%>
                    <span>기간 :&nbsp;
...
<script>
    ...
    const grid1ColumnLayout = [
        ...
        { dataField: "MGM_DEPT_NM",
            headerText: "관리부서",
            dataType: "text",
            width : "10%",
        },
        { dataField: "DOC_STORAGE_NAME",
            headerText: "문서보관함",
            dataType: "text",
            width : "15%",
        },
