...
<jsp:include page="/WEB-INF/jsp/section/sojang/soj_nav.jsp" />
    ...
    <div id="section">
        <div class="section1">
            <div class="section1_nav">
                <i class="icon-star-filled"></i>세부그룹별메뉴관리
            </div>
        ...
        <div class="section2">
            <div class="section2_line1">
                <span class="select-container">&emsp; 권한그룹 :&nbsp;
                    <select id="search_usergroupId" class="select_cont100" onchange="search_usergroupId_change(this)">
                    </select>
                </span>&emsp;
                <span class="select-container">&nbsp; 세부권한그룹 :&nbsp;
                    <select id="search_subUsergroupId" class="select_cont100">
                    </select>
                </span>
            </div>
        </div>
    ...
    <script>
        ...
        //변수 선언
        const pgId = "soj07030";	//프로그램ID
        let grid1;	// 그리드 컴포넌트
        let focus = 0;	//그리드 컴포넌트 포커스
        const search_usergroupId = document.querySelector("#search_usergroupId");	//select 컴포넌트 : 권한그룹
        const search_subUsergroupId = document.querySelector("#search_subUsergroupId");	//select 컴포넌트 : 세부권한그룹
        ...
        function search_grid1_onclick(){
            ...
            //검색데이터
            let selectParam = {
                USERGROUP_ID : isNull(search_subUsergroupId.value) ? search_usergroupId.value : search_subUsergroupId.value
            }
        ...
        function save_grid1_onclick(){
            ...
            let saveParam = {
                insertParam : editedRowItems.filter(row => isNull(row.USERGROUP_ID))
                    .map(row => ({ ...row, USERGROUP_ID:  isNull(search_subUsergroupId.value) ? search_usergroupId.value : search_subUsergroupId.value })),
