...
<jsp:include page="/WEB-INF/jsp/section/sojang/soj_nav.jsp" />
        ...
        <div id="section">
            <div class="section1">
                ...
                <div class="section1_btn" id="search1_btn"></div>
            </div>
            <div class="section2">
...
<script>
    ...
    function search_grid2_onclick(){
        ...
        let selectParam = {
            ...
            USERGROUP_ID : AUIGrid.getSelectedRows(grid1)[0].USERGROUP_ID
        }
    ...
    window.onload = function() {
        ...
        btnMaker({ tag: "#section1_btn", grid:"grid1", search: true, save: true, add: true, del: true});
        //crud 권한 처리 함수
