            ...
            <div class="section2">
                <div class="section2_line1">
                    ...
                    <span class="search-box">충전기간 :&nbsp;
                        <input class="search-txt100" type="date" id="search_stDate" data-format="date">&nbsp; ~ &nbsp;
                        <input class="search-txt100" type="date" id="search_endDate" data-format="date">
                    </span>
                </div> 
            </div>
            <div id="grid1"></div>
...
<script>
    ...
    window.onload = function() {
        ...
        btnMaker({ tag: "#section1_btn", grid: "grid1", search : true, add : true, save: true, del : true});
        //crud 권한 처리 함수
