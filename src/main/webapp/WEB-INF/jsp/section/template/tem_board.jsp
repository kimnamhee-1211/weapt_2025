...
<jsp:include page="/WEB-INF/jsp/section/template/tem_nav.jsp" />
    ...
    <div id="section">
        <div class="section1">
            <span class="section1_nav"><i class="icon-chart-bar"></i>tem_board</span>
...
<script>
    ...
    window.onload = function() {
        ...
        let pop_item = {
            pgId : pgId,
            pop_title : "&#10004;&nbsp tem_board",  //팝업 title
            querySet : "tem_board",                 //동일 쿼리 사용시
