        ...
        <div id="section">
            ...
            <div class="section2">
                <div class="section2_line1">
                    <span>select :&nbsp;
                        <select id="search_select" name="" class="select_cont100"></select>
                    </span>
                    <span class="select-container">&emsp;date :&nbsp;
                         <input class="search-txt100" type="date" id="search_date">
                    </span>
                    <span class="select-container">&emsp;input :&nbsp;
                         <input class="search-txt100" type="text" id="search_input">
                    </span>
                </div>
            </div>
            <div id="grid1"></div>
