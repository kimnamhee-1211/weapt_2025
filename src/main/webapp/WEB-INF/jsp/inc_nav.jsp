<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    <div id="nav_resize">
        <div id="nav">
            <ul id="nav_top">
                <li id="topnav_iljung"><a id="iljung/010">일정관리</a></li>
                <li id="topnav_minwon"><a id="minwon/020">민원관리</a></li>
                <li id="topnav_ilban"><a id="ilban/030">관리일반</a></li>
                <li id="topnav_haeng"><a id="haeng/040">행정관리</a></li>
                <li id="topnav_ilgee"><a id="ilgee/050">일지결재</a></li>
                <li id="topnav_jaego"><a id="jaego/060">재고관리</a></li>
                <li id="topnav_jangbi"><a id="jangbi/070">장비관리</a></li>
                <li id="topnav_hwan"><a id="hwan/080">환경보완</a></li>
                <li id="topnav_jangsoo"><a id="jangsoo/090">장기수선</a></li>
                <li id="topnav_danche"><a id="danche/100">회의단체</a></li>
                <li id="topnav_sojang"><a id="sojang/110">관리소장</a></li>
            </ul>
